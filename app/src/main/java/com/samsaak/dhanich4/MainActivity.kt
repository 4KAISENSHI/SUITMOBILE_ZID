...
import com.samsaak.dhanich4.landingPage.LandingPageActivity
import com.samsaak.dhanich4.databinding.ActivityMainBinding
...
//      Set player choice
    ...
    private fun initialConfig() {
        binding.run {
            if(data?.player == "") titlePlayer.text = "Pemain 1"
